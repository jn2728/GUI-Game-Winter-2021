...
//just import a ton of libraries
 
public class Guess{//class guess
    ...
    private static JButton NewGame;//static variables
public static void main(String[] args){//main methid
  ...
  mainPanel.add(input);
  mainPanel.add(NewGame);//add everything to the jPanel
...
public void randomNum(){//dont use this
...
private static class Handler implements ActionListener{
  ...
  else{//this is for the first one, as it doesnt change colors on the first guess
...
private static class newGameHandler implements ActionListener{
     public void actionPerformed(ActionEvent event){
         //just sets everything back to neutral
